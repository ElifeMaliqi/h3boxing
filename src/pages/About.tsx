...
import { Zap, Award, Users, Clock, Cpu, Shield, Rocket, Hexagon, Sparkles } from 'lucide-react';

const About = () => {
  const stats = [
    { icon: Award, number: '10+', label: 'Jahre Erfahrung', glow: 'red-500' },
    { icon: Users, number: '500+', label: 'Zufriedene Mitglieder', glow: 'cyan-400' },
    { icon: Clock, number: '24/7', label: 'Flexible Trainingszeiten', glow: 'purple-500' },
  ];
    ...
    <div className="pt-16 relative overflow-hidden">
      ...
      <section className="relative py-20 overflow-hidden">
        ...
        <div 
          ...
          style={{
            backgroundImage: 'url("/images/1FDBA8B8-EDF8-441F-BBA4-4B59E37E6814.JPG")',
