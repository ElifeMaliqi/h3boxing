            ...
            <div key={categoryIndex} className="mb-16 last:mb-0">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-5xl mx-auto">
                {category.plans.map((plan, planIndex) => (
                  <div
                    key={planIndex}
                    className={`group relative bg-gradient-to-br from-gray-900/80 via-black/90 to-gray-900/80 backdrop-blur-sm p-8 rounded-3xl border transition-all duration-500 transform hover:scale-105 overflow-hidden ${
                      plan.popular 
