...
const AGB = () => {
  const sections = [
    ...
    },
    {
      ...
      content: [
        'H3 Boxing übernimmt keine Haftung für Verletzungen, Unfälle oder Schäden, die während oder infolge des Trainings auftreten, ausser bei nachweislich grobfahrlässigem oder vorsätzlichem Verhalten.',
        'Keine Haftung besteht für Verlust oder Diebstahl persönlicher Gegenstände.',
        'Wir empfehlen allen Mitgliedern, eine private Unfall- und Haftpflichtversicherung abzuschliessen.'
      ],
      glow: 'violet-500'
    },
    {
    ...
    },
    {
      ...
      content: [
        ...
        'Die Veröffentlichung erfolgt nur mit deiner ausdrücklichen Zustimmung.'
      ],
      glow: 'purple-500'
    },
    {
